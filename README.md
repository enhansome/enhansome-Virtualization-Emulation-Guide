...
[Quickemu](https://github.com/wimpysworld/quickemu) ⭐ 16,126 | 🐛 69 | 🌐 Shell | 📅 2026-08-28 is a program that quickly create and run optimised Windows, macOS and Linux desktop virtual machines.
...
[Cloud Hypervisor](https://github.com/cloud-hypervisor/cloud-hypervisor) ⭐ 6,195 | 🐛 227 | 🌐 Rust | 📅 2026-09-05 is an open source Virtual Machine Monitor (VMM) that runs on top of [KVM](https://www.kernel.org/doc/Documentation/virtual/kvm/api.txt). The project focuses on exclusively running modern, cloud workloads, on top of a limited set of hardware architectures and platforms. Cloud workloads refers to those that are usually run by customers inside a cloud provider. Cloud Hypervisor is implemented in [Rust](https://www.rust-lang.org/) and is based on the [rust-vmm](https://github.com/rust-vmm) crates.

[VirtManager](https://github.com/virt-manager/virt-manager) ⭐ 3,244 | 🐛 157 | 🌐 Python | 📅 2026-09-04 is a graphical tool for managing virtual machines via libvirt. Most usage is with QEMU/KVM virtual machines, but Xen and libvirt LXC containers are well supported. Common operations for any libvirt driver should work.
...
[cURL Fuzzer](https://github.com/curl/curl-fuzzer) ⭐ 99 | 🐛 12 | 🌐 C++ | 📅 2026-09-07 is a quality assurance testing for the curl project.
...
[Kubespray](https://kubespray.io/) is a tool that combines Kubernetes and Ansible to easily install Kubernetes clusters that can be deployed on [AWS](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/aws.md) ⭐ 18,716 | 🐛 225 | 🌐 Jinja | 📅 2026-09-05, GCE, [Azure](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/azure.md) ⭐ 18,716 | 🐛 225 | 🌐 Jinja | 📅 2026-09-05, [OpenStack](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/openstack.md) ⭐ 18,716 | 🐛 225 | 🌐 Jinja | 📅 2026-09-05, [vSphere](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/vsphere.md) ⭐ 18,716 | 🐛 225 | 🌐 Jinja | 📅 2026-09-05, [Packet](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/packet.md) ⭐ 18,716 | 🐛 225 | 🌐 Jinja | 📅 2026-09-05 (bare metal), Oracle Cloud Infrastructure (Experimental), or Baremetal.
...
[K3s](https://github.com/rancher/k3s) ⭐ 33,899 | 🐛 76 | 🌐 Go | 📅 2026-09-04 is a highly available, certified Kubernetes distribution designed for production workloads in unattended, resource-constrained, remote locations or inside IoT appliances.
...
[OpenWiFi](https://github.com/open-sdr/openwifi) ⭐ 4,788 | 🐛 93 | 🌐 C | 📅 2026-08-25 is an open-source IEEE802.11/Wi-Fi baseband chip/FPGA design.
...
[Unicorn](https://github.com/unicorn-engine/unicorn) ⭐ 9,306 | 🐛 215 | 🌐 C | 📅 2026-08-28 is a lightweight, multi-platform, multi-architecture CPU emulator framework(ARM, AArch64, M68K, Mips, Sparc, X86) based on [QEMU](https://www.qemu.org/).
...
[Chainer](https://chainer.org/) is a Python-based deep learning framework aiming at flexibility. It provides automatic differentiation APIs based on the define-by-run approach (dynamic computational graphs) as well as object-oriented high-level APIs to build and train neural networks. It also supports CUDA/cuDNN using [CuPy](https://github.com/cupy/cupy) ⭐ 12,305 | 🐛 699 | 🌐 Python | 📅 2026-09-06 for high performance training and inference.
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,440 | 🐛 1,184 | 🌐 CMake | 📅 2026-09-04 is a C++ Library Manager for Windows, Linux, and MacOS.
...
[Spdlog](https://github.com/gabime/spdlog) ⭐ 29,581 | 🐛 47 | 🌐 C++ | 📅 2026-09-05 is a very fast, header-only/compiled, C++ logging library.
...
[AutoRest](https://github.com/Azure/autorest) ⭐ 4,799 | 🐛 24 | 🌐 TypeSpec | 📅 2026-08-31 is a tool generates client libraries for accessing RESTful web services using the [OpenAPI Specification](https://github.com/OAI/OpenAPI-Specification) ⭐ 31,205 | 🐛 76 | 🌐 Markdown | 📅 2026-09-01 format. It Supports C#, PowerShell, Go, Java, Node.js, TypeScript, Python, Ruby.

[Markdig](https://github.com/lunet-io/markdig) ⭐ 5,321 | 🐛 120 | 🌐 C# | 📅 2026-08-18 is a fast, powerful, [CommonMark](https://commonmark.org/) compliant, extensible Markdown processor for .NET.
...
[Pyright](https://github.com/Microsoft/pyright) ⭐ 15,622 | 🐛 341 | 🌐 Python | 📅 2026-09-04 is a fast type checker meant for large Python source bases. It can run in a “watch” mode and performs fast incremental updates when files are modified.
...
[Locust](https://github.com/locustio/locust) ⭐ 28,134 | 🐛 5 | 🌐 Python | 📅 2026-09-06 is an easy to use, scriptable and scalable performance testing tool.

[spaCy](https://github.com/explosion/spaCy) ⭐ 33,878 | 🐛 239 | 🌐 Python | 📅 2026-08-24 is a library for advanced Natural Language Processing in Python and Cython.
...
[Cargo](https://github.com/rust-lang/cargo) ⭐ 15,454 | 🐛 1,659 | 🌐 Rust | 📅 2026-09-05 is a package manager that downloads your Rust project’s dependencies and compiles your project.
...
[Apache Arrow](https://github.com/apache/arrow) ⭐ 17,089 | 🐛 2,589 | 🌐 C++ | 📅 2026-09-06 is a development platform for in-memory analytics. It contains a set of technologies that enable big data systems to process and move data fast. Arrow's libraries are available for C, C++, C#, Go, Java, JavaScript, MATLAB, Python, R, Ruby, and Rust.

[Wasmer](https://wasmer.io/) enables super lightweight containers based on [WebAssembly](https://webassembly.org/) that can run anywhere such as the Desktop to the Cloud and IoT devices, and also embedded in [any programming language](https://github.com/wasmerio/wasmer#language-integrations) ⭐ 21,019 | 🐛 255 | 🌐 Rust | 📅 2026-09-07.
...
[Tokio](https://github.com/tokio-rs/tokio) ⭐ 33,086 | 🐛 445 | 🌐 Rust | 📅 2026-09-07 is an event-driven, non-blocking I/O platform for writing asynchronous applications with the Rust programming language.

[TiKV](https://github.com/tikv/tikv) ⭐ 16,833 | 🐛 1,807 | 🌐 Rust | 📅 2026-09-03 is an open-source distributed transactional key-value database that also provides classical key-vlue APIs, but also transactional APIs with ACID compliance.
...
[Hyper](https://github.com/hyperium/hyper) ⭐ 16,309 | 🐛 245 | 🌐 Rust | 📅 2026-09-01 is a fast and correct HTTP library for Rust.
...
[Servo](https://github.com/servo/servo) ⭐ 37,932 | 🐛 3,198 | 🌐 Rust | 📅 2026-09-07 is a prototype web browser engine written in the Rust language.
...
[Rustlings](https://github.com/rust-lang/rustlings) ⭐ 64,057 | 🐛 35 | 🌐 Rust | 📅 2026-08-30 is a small set of exercises to get you used to reading and writing Rust code.
...
[Traefik](https://github.com/traefik/traefik) ⭐ 64,765 | 🐛 908 | 🌐 Go | 📅 2026-09-04 is a modern HTTP reverse proxy and load balancer that makes deploying microservices easy. Traefik integrates with your existing infrastructure components (Docker, Swarm mode, Kubernetes, Marathon, Consul, Etcd, Rancher, Amazon ECS, etc.) and configures itself automatically and dynamically. Pointing Traefik at your orchestrator should be the only configuration step you need.

[Gitea](https://github.com/go-gitea/gitea) ⭐ 57,855 | 🐛 2,520 | 🌐 Go | 📅 2026-09-07 is Git with a cup of tea, painless self-hosted git service. Using Go, this can be done with an independent binary distribution across all platforms which Go supports, including Linux, macOS, and Windows on x86, amd64, ARM and PowerPC architectures.
...
[Act](https://github.com/nektos/act) ⭐ 71,832 | 🐛 378 | 🌐 Go | 📅 2026-08-09 is a GO program that allows you to run our GitHub Actions locally.

[Fiber](https://gofiber.io/) is an [Express](https://github.com/expressjs/express) ⭐ 69,453 | 🐛 234 | 🌐 JavaScript | 📅 2026-09-01 inspired web framework built on top of [Fasthttp](https://github.com/valyala/fasthttp) ⭐ 23,465 | 🐛 86 | 🌐 Go | 📅 2026-09-07, the fastest HTTP engine for Go. Designed to ease things up for fast development with zero memory allocation and performance in mind.
...
[Go kit](https://github.com/go-kit/kit) ⭐ 27,419 | 🐛 60 | 🌐 Go | 📅 2024-07-19 is a programming toolkit for building microservices (or elegant monoliths) in Go. We solve common problems in distributed systems and application architecture so you can focus on delivering business value.
...
[zap](https://github.com/uber-go/zap) ⭐ 24,647 | 🐛 185 | 🌐 Go | 📅 2026-08-31 is a blazing fast, structured, leveled logging in Go.
...
[Delve](https://github.com/go-delve/delve) ⭐ 24,909 | 🐛 84 | 🌐 Go | 📅 2026-09-04 is a debugger for the Go programming language.
...
[Go Patterns](https://github.com/tmrts/go-patterns) ⭐ 28,225 | 🐛 66 | 🌐 Go | 📅 2024-05-14 is a curated collection of idiomatic design & application patterns for Go language.
...
[Java Design Patterns ](https://github.com/iluwatar/java-design-patterns) ⭐ 94,666 | 🐛 129 | 🌐 Java | 📅 2026-08-31 is a collection of the best formalized practices a programmer can use to solve common problems when designing an application or system.
...
[Swift Evolution](https://github.com/apple/swift-evolution) ⭐ 15,869 | 🐛 90 | 🌐 Markdown | 📅 2026-09-06 maintains proposals for changes and user-visible enhancements to the Swift Programming Language.
...
[Swift GitHub](https://github.com/apple/swift) ⭐ 70,332 | 🐛 9,264 | 🌐 Swift | 📅 2026-09-06
