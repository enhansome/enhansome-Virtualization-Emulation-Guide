...
[Quickemu](https://github.com/wimpysworld/quickemu) ⭐ 16,151 | 🐛 70 | 🌐 Shell | 📅 2026-08-28 is a program that quickly create and run optimised Windows, macOS and Linux desktop virtual machines.
...
[Cloud Hypervisor](https://github.com/cloud-hypervisor/cloud-hypervisor) ⭐ 6,210 | 🐛 225 | 🌐 Rust | 📅 2026-09-09 is an open source Virtual Machine Monitor (VMM) that runs on top of [KVM](https://www.kernel.org/doc/Documentation/virtual/kvm/api.txt). The project focuses on exclusively running modern, cloud workloads, on top of a limited set of hardware architectures and platforms. Cloud workloads refers to those that are usually run by customers inside a cloud provider. Cloud Hypervisor is implemented in [Rust](https://www.rust-lang.org/) and is based on the [rust-vmm](https://github.com/rust-vmm) crates.
...
[HTTPie](https://github.com/httpie/httpie) ⭐ 38,490 | 🐛 337 | 🌐 Python | 📅 2024-12-17 is a command-line HTTP client. Its goal is to make CLI interaction with web services as human-friendly as possible. HTTPie is designed for testing, debugging, and generally interacting with APIs & HTTP servers.
...
[Kata Operator](https://github.com/openshift/kata-operator) ⭐ 50 | 🐛 49 | 🌐 Shell | 📅 2026-09-10 is an operator to perform lifecycle management (install/upgrade/uninstall) of [Kata Runtime](https://katacontainers.io/) on Openshift as well as Kubernetes cluster.

[Thanos](https://thanos.io/) is a set of components that can be composed into a highly available metric system with unlimited storage capacity, which can be added seamlessly on top of existing Prometheus deployments.

[OpenShift Hive](https://github.com/openshift/hive) ⭐ 275 | 🐛 6 | 🌐 Go | 📅 2026-09-03 is an operator which runs as a service on top of Kubernetes/OpenShift. The Hive service can be used to provision and perform initial configuration of OpenShift 4 clusters.
...
[Kubespray](https://kubespray.io/) is a tool that combines Kubernetes and Ansible to easily install Kubernetes clusters that can be deployed on [AWS](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/aws.md) ⭐ 18,722 | 🐛 213 | 🌐 Jinja | 📅 2026-09-10, GCE, [Azure](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/azure.md) ⭐ 18,722 | 🐛 213 | 🌐 Jinja | 📅 2026-09-10, [OpenStack](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/openstack.md) ⭐ 18,722 | 🐛 213 | 🌐 Jinja | 📅 2026-09-10, [vSphere](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/vsphere.md) ⭐ 18,722 | 🐛 213 | 🌐 Jinja | 📅 2026-09-10, [Packet](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/packet.md) ⭐ 18,722 | 🐛 213 | 🌐 Jinja | 📅 2026-09-10 (bare metal), Oracle Cloud Infrastructure (Experimental), or Baremetal.
...
[K3s](https://github.com/rancher/k3s) ⭐ 33,926 | 🐛 87 | 🌐 Go | 📅 2026-09-09 is a highly available, certified Kubernetes distribution designed for production workloads in unattended, resource-constrained, remote locations or inside IoT appliances.
...
[Apio](https://github.com/FPGAwars/apio) ⭐ 1,007 | 🐛 42 | 🌐 Python | 📅 2026-09-10 is a multiplatform toolbox, with static pre-built packages, project configuration tools and easy command interface to verify, synthesize, simulate and upload your verilog designs.
...
[FuseSoC](https://github.com/olofk/fusesoc) ⭐ 1,456 | 🐛 150 | 🌐 Python | 📅 2026-09-08 is an award-winning package manager and a set of build tools for HDL (Hardware Description Language) code and FPGA/ASIC development.

[OpenWiFi](https://github.com/open-sdr/openwifi) ⭐ 4,791 | 🐛 94 | 🌐 C | 📅 2026-08-25 is an open-source IEEE802.11/Wi-Fi baseband chip/FPGA design.
...
[Unicorn](https://github.com/unicorn-engine/unicorn) ⭐ 9,314 | 🐛 215 | 🌐 C | 📅 2026-08-28 is a lightweight, multi-platform, multi-architecture CPU emulator framework(ARM, AArch64, M68K, Mips, Sparc, X86) based on [QEMU](https://www.qemu.org/).

[Keystone](https://github.com/keystone-engine/keystone) ⭐ 2,631 | 🐛 242 | 🌐 C++ | 📅 2026-07-18 is a lightweight multi-platform, multi-architecture(Arm, Arm64, Hexagon, Mips, PowerPC, Sparc, SystemZ & X86) assembler framework.
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,451 | 🐛 1,173 | 🌐 CMake | 📅 2026-09-10 is a C++ Library Manager for Windows, Linux, and MacOS.
...
[AutoRest](https://github.com/Azure/autorest) ⭐ 4,799 | 🐛 24 | 🌐 TypeSpec | 📅 2026-08-31 is a tool generates client libraries for accessing RESTful web services using the [OpenAPI Specification](https://github.com/OAI/OpenAPI-Specification) ⭐ 31,212 | 🐛 80 | 🌐 Markdown | 📅 2026-09-01 format. It Supports C#, PowerShell, Go, Java, Node.js, TypeScript, Python, Ruby.
...
[Pyright](https://github.com/Microsoft/pyright) ⭐ 15,626 | 🐛 341 | 🌐 Python | 📅 2026-09-09 is a fast type checker meant for large Python source bases. It can run in a “watch” mode and performs fast incremental updates when files are modified.
...
[Cargo](https://github.com/rust-lang/cargo) ⭐ 15,462 | 🐛 1,667 | 🌐 Rust | 📅 2026-09-08 is a package manager that downloads your Rust project’s dependencies and compiles your project.
...
[Tokio](https://github.com/tokio-rs/tokio) ⭐ 33,102 | 🐛 442 | 🌐 Rust | 📅 2026-09-10 is an event-driven, non-blocking I/O platform for writing asynchronous applications with the Rust programming language.

[TiKV](https://github.com/tikv/tikv) ⭐ 16,839 | 🐛 1,806 | 🌐 Rust | 📅 2026-09-10 is an open-source distributed transactional key-value database that also provides classical key-vlue APIs, but also transactional APIs with ACID compliance.
...
[Hyper](https://github.com/hyperium/hyper) ⭐ 16,312 | 🐛 240 | 🌐 Rust | 📅 2026-09-09 is a fast and correct HTTP library for Rust.

[Rocket](https://github.com/SergioBenitez/Rocket) ⭐ 25,780 | 🐛 90 | 🌐 Rust | 📅 2025-12-28 is an async web framework for Rust with a focus on usability, security, extensibility, and speed.
...
[Servo](https://github.com/servo/servo) ⭐ 37,951 | 🐛 3,191 | 🌐 Rust | 📅 2026-09-10 is a prototype web browser engine written in the Rust language.
...
[RustPython](https://github.com/RustPython/RustPython) ⭐ 22,342 | 🐛 398 | 🌐 Rust | 📅 2026-09-10 is a Python Interpreter written in Rust.

[Miri](https://github.com/rust-lang/miri) ⭐ 6,570 | 🐛 183 | 🌐 Rust | 📅 2026-09-10 is an interpreter for Rust's mid-level intermediate representation. It can run binaries and test suites of cargo projects and detect certain classes of undefined behavior. Miri will alsowill also tell you about memory leaks: when there is memory still allocated at the end of the execution, and that memory is not reachable from a global static, Miri will raise an error.
...
[Simpleinfra](https://github.com/rust-lang/simpleinfra) ⭐ 177 | 🐛 68 | 🌐 HCL | 📅 2026-09-09 is rep that contains the tools and automation written by the Rust infrastructure team to manage our services. Using some of the tools in this repo require privileges only infra team members have.

[Rustlings](https://github.com/rust-lang/rustlings) ⭐ 64,114 | 🐛 35 | 🌐 Rust | 📅 2026-08-30 is a small set of exercises to get you used to reading and writing Rust code.
...
[Bottlerocket OS](https://github.com/bottlerocket-os/bottlerocket) ⭐ 9,671 | 🐛 202 | 🌐 Rust | 📅 2026-09-09 is an open-source Linux-based operating system meant for hosting containers. Bottlerocket focuses on security and maintainability, providing a reliable, consistent, and safe platform for container-based workloads.
...
[Uber's Go Style Guide](https://github.com/uber-go/guide/blob/master/style.md) ⭐ 17,697 | 🐛 39 | 🌐 Makefile | 📅 2026-04-15
...
[Traefik](https://github.com/traefik/traefik) ⭐ 64,799 | 🐛 923 | 🌐 Go | 📅 2026-09-09 is a modern HTTP reverse proxy and load balancer that makes deploying microservices easy. Traefik integrates with your existing infrastructure components (Docker, Swarm mode, Kubernetes, Marathon, Consul, Etcd, Rancher, Amazon ECS, etc.) and configures itself automatically and dynamically. Pointing Traefik at your orchestrator should be the only configuration step you need.

[Gitea](https://github.com/go-gitea/gitea) ⭐ 57,920 | 🐛 2,455 | 🌐 Go | 📅 2026-09-10 is Git with a cup of tea, painless self-hosted git service. Using Go, this can be done with an independent binary distribution across all platforms which Go supports, including Linux, macOS, and Windows on x86, amd64, ARM and PowerPC architectures.
...
[Act](https://github.com/nektos/act) ⭐ 71,867 | 🐛 378 | 🌐 Go | 📅 2026-08-09 is a GO program that allows you to run our GitHub Actions locally.

[Fiber](https://gofiber.io/) is an [Express](https://github.com/expressjs/express) ⭐ 69,445 | 🐛 230 | 🌐 JavaScript | 📅 2026-09-08 inspired web framework built on top of [Fasthttp](https://github.com/valyala/fasthttp) ⭐ 23,470 | 🐛 90 | 🌐 Go | 📅 2026-09-09, the fastest HTTP engine for Go. Designed to ease things up for fast development with zero memory allocation and performance in mind.
...
[zap](https://github.com/uber-go/zap) ⭐ 24,648 | 🐛 189 | 🌐 Go | 📅 2026-08-31 is a blazing fast, structured, leveled logging in Go.
...
[Java Design Patterns ](https://github.com/iluwatar/java-design-patterns) ⭐ 94,676 | 🐛 130 | 🌐 Java | 📅 2026-08-31 is a collection of the best formalized practices a programmer can use to solve common problems when designing an application or system.
...
[Guava](https://github.com/google/guava) ⭐ 51,895 | 🐛 754 | 🌐 Java | 📅 2026-09-09 is a set of core Java libraries from Google that includes new collection types (such as multimap and multiset), immutable collections, a graph library, and utilities for concurrency, I/O, hashing, caching, primitives, strings, and more! It is widely used on most Java projects within Google, and widely used by many other companies as well.
...
[Swift Evolution](https://github.com/apple/swift-evolution) ⭐ 15,869 | 🐛 92 | 🌐 Markdown | 📅 2026-09-07 maintains proposals for changes and user-visible enhancements to the Swift Programming Language.
...
[Swift GitHub](https://github.com/apple/swift) ⭐ 70,334 | 🐛 9,299 | 🌐 Swift | 📅 2026-09-10
...
[Vapor](https://github.com/vapor/vapor) ⭐ 26,191 | 🐛 103 | 🌐 Swift | 📅 2026-09-09 is a web framework for Swift. It provides a beautifully expressive and easy to use foundation for your next website, API, or cloud project.
...
[Perfect](https://github.com/PerfectlySoft/Perfect) ⭐ 13,736 | 🐛 65 | 🌐 Swift | 📅 2024-02-03 is a complete and powerful toolbox, framework, and application server for Linux, iOS, and macOS (OS X). It provides everything a Swift engineer needs for developing lightweight, maintainable, and scalable apps and other REST services entirely in the Swift programming language for both client-facing and server-side applications.

[Alamofire](https://github.com/Alamofire/Alamofire) ⭐ 42,421 | 🐛 43 | 🌐 Swift | 📅 2026-09-10 is an HTTP networking library written in Swift.
