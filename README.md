...
[Quickemu](https://github.com/wimpysworld/quickemu) ⭐ 15,619 | 🐛 64 | 🌐 Shell | 📅 2026-07-28 is a program that quickly create and run optimised Windows, macOS and Linux desktop virtual machines.
...
[Kata Operator](https://github.com/openshift/kata-operator) ⭐ 50 | 🐛 61 | 🌐 Shell | 📅 2026-08-13 is an operator to perform lifecycle management (install/upgrade/uninstall) of [Kata Runtime](https://katacontainers.io/) on Openshift as well as Kubernetes cluster.
...
[Kubespray](https://kubespray.io/) is a tool that combines Kubernetes and Ansible to easily install Kubernetes clusters that can be deployed on [AWS](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/aws.md) ⭐ 18,675 | 🐛 198 | 🌐 Jinja | 📅 2026-08-11, GCE, [Azure](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/azure.md) ⭐ 18,675 | 🐛 198 | 🌐 Jinja | 📅 2026-08-11, [OpenStack](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/openstack.md) ⭐ 18,675 | 🐛 198 | 🌐 Jinja | 📅 2026-08-11, [vSphere](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/vsphere.md) ⭐ 18,675 | 🐛 198 | 🌐 Jinja | 📅 2026-08-11, [Packet](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/packet.md) ⭐ 18,675 | 🐛 198 | 🌐 Jinja | 📅 2026-08-11 (bare metal), Oracle Cloud Infrastructure (Experimental), or Baremetal.
...
[K3s](https://github.com/rancher/k3s) ⭐ 33,728 | 🐛 69 | 🌐 Go | 📅 2026-08-12 is a highly available, certified Kubernetes distribution designed for production workloads in unattended, resource-constrained, remote locations or inside IoT appliances.
...
[FuseSoC](https://github.com/olofk/fusesoc) ⭐ 1,447 | 🐛 152 | 🌐 Python | 📅 2026-08-11 is an award-winning package manager and a set of build tools for HDL (Hardware Description Language) code and FPGA/ASIC development.

[OpenWiFi](https://github.com/open-sdr/openwifi) ⭐ 4,749 | 🐛 93 | 🌐 C | 📅 2026-08-12 is an open-source IEEE802.11/Wi-Fi baseband chip/FPGA design.
...
[Unicorn](https://github.com/unicorn-engine/unicorn) ⭐ 9,229 | 🐛 209 | 🌐 C | 📅 2026-07-30 is a lightweight, multi-platform, multi-architecture CPU emulator framework(ARM, AArch64, M68K, Mips, Sparc, X86) based on [QEMU](https://www.qemu.org/).

[Keystone](https://github.com/keystone-engine/keystone) ⭐ 2,623 | 🐛 243 | 🌐 C++ | 📅 2026-07-18 is a lightweight multi-platform, multi-architecture(Arm, Arm64, Hexagon, Mips, PowerPC, Sparc, SystemZ & X86) assembler framework.
...
[Cargo](https://github.com/rust-lang/cargo) ⭐ 15,378 | 🐛 1,658 | 🌐 Rust | 📅 2026-08-12 is a package manager that downloads your Rust project’s dependencies and compiles your project.
...
[Apache Arrow](https://github.com/apache/arrow) ⭐ 17,016 | 🐛 2,565 | 🌐 C++ | 📅 2026-08-13 is a development platform for in-memory analytics. It contains a set of technologies that enable big data systems to process and move data fast. Arrow's libraries are available for C, C++, C#, Go, Java, JavaScript, MATLAB, Python, R, Ruby, and Rust.

[Wasmer](https://wasmer.io/) enables super lightweight containers based on [WebAssembly](https://webassembly.org/) that can run anywhere such as the Desktop to the Cloud and IoT devices, and also embedded in [any programming language](https://github.com/wasmerio/wasmer#language-integrations) ⭐ 20,951 | 🐛 222 | 🌐 Rust | 📅 2026-08-12.
...
[Tokio](https://github.com/tokio-rs/tokio) ⭐ 32,925 | 🐛 414 | 🌐 Rust | 📅 2026-08-11 is an event-driven, non-blocking I/O platform for writing asynchronous applications with the Rust programming language.

[TiKV](https://github.com/tikv/tikv) ⭐ 16,796 | 🐛 1,811 | 🌐 Rust | 📅 2026-08-13 is an open-source distributed transactional key-value database that also provides classical key-vlue APIs, but also transactional APIs with ACID compliance.
...
[Rocket](https://github.com/SergioBenitez/Rocket) ⭐ 25,777 | 🐛 84 | 🌐 Rust | 📅 2025-12-28 is an async web framework for Rust with a focus on usability, security, extensibility, and speed.
...
[Servo](https://github.com/servo/servo) ⭐ 37,687 | 🐛 3,137 | 🌐 Rust | 📅 2026-08-13 is a prototype web browser engine written in the Rust language.
...
[RustPython](https://github.com/RustPython/RustPython) ⭐ 22,276 | 🐛 404 | 🌐 Rust | 📅 2026-08-13 is a Python Interpreter written in Rust.

[Miri](https://github.com/rust-lang/miri) ⭐ 6,491 | 🐛 176 | 🌐 Rust | 📅 2026-08-09 is an interpreter for Rust's mid-level intermediate representation. It can run binaries and test suites of cargo projects and detect certain classes of undefined behavior. Miri will alsowill also tell you about memory leaks: when there is memory still allocated at the end of the execution, and that memory is not reachable from a global static, Miri will raise an error.
...
[Simpleinfra](https://github.com/rust-lang/simpleinfra) ⭐ 175 | 🐛 65 | 🌐 HCL | 📅 2026-08-12 is rep that contains the tools and automation written by the Rust infrastructure team to manage our services. Using some of the tools in this repo require privileges only infra team members have.

[Rustlings](https://github.com/rust-lang/rustlings) ⭐ 63,858 | 🐛 34 | 🌐 Rust | 📅 2026-08-11 is a small set of exercises to get you used to reading and writing Rust code.
...
[Bottlerocket OS](https://github.com/bottlerocket-os/bottlerocket) ⭐ 9,660 | 🐛 197 | 🌐 Rust | 📅 2026-08-05 is an open-source Linux-based operating system meant for hosting containers. Bottlerocket focuses on security and maintainability, providing a reliable, consistent, and safe platform for container-based workloads.
...
[Traefik](https://github.com/traefik/traefik) ⭐ 64,441 | 🐛 890 | 🌐 Go | 📅 2026-08-12 is a modern HTTP reverse proxy and load balancer that makes deploying microservices easy. Traefik integrates with your existing infrastructure components (Docker, Swarm mode, Kubernetes, Marathon, Consul, Etcd, Rancher, Amazon ECS, etc.) and configures itself automatically and dynamically. Pointing Traefik at your orchestrator should be the only configuration step you need.

[Gitea](https://github.com/go-gitea/gitea) ⭐ 57,350 | 🐛 2,625 | 🌐 Go | 📅 2026-08-13 is Git with a cup of tea, painless self-hosted git service. Using Go, this can be done with an independent binary distribution across all platforms which Go supports, including Linux, macOS, and Windows on x86, amd64, ARM and PowerPC architectures.
...
[Act](https://github.com/nektos/act) ⭐ 71,491 | 🐛 360 | 🌐 Go | 📅 2026-08-09 is a GO program that allows you to run our GitHub Actions locally.
...
[Guava](https://github.com/google/guava) ⭐ 51,912 | 🐛 750 | 🌐 Java | 📅 2026-08-12 is a set of core Java libraries from Google that includes new collection types (such as multimap and multiset), immutable collections, a graph library, and utilities for concurrency, I/O, hashing, caching, primitives, strings, and more! It is widely used on most Java projects within Google, and widely used by many other companies as well.
...
[Swift Evolution](https://github.com/apple/swift-evolution) ⭐ 15,865 | 🐛 72 | 🌐 Markdown | 📅 2026-08-12 maintains proposals for changes and user-visible enhancements to the Swift Programming Language.
...
[Swift GitHub](https://github.com/apple/swift) ⭐ 70,246 | 🐛 9,186 | 🌐 Swift | 📅 2026-08-13
...
[Kingfisher](https://github.com/onevcat/Kingfisher) ⭐ 24,390 | 🐛 170 | 🌐 Swift | 📅 2026-08-10 is a powerful, pure-Swift library for downloading and caching images from the web. It provides you a chance to use a pure-Swift way to work with remote images in your next app.
...
[Alamofire](https://github.com/Alamofire/Alamofire) ⭐ 42,416 | 🐛 44 | 🌐 Swift | 📅 2026-08-03 is an HTTP networking library written in Swift.

[Eureka](https://github.com/xmartlabs/Eureka) ⭐ 11,805 | 🐛 179 | 🌐 Swift | 📅 2024-09-12 is an elegant iOS form builder in Swift

[Carthage](https://github.com/Carthage/Carthage) ⭐ 15,176 | 🐛 216 | 🌐 Swift | 📅 2025-09-10 is intended to be the simplest way to add frameworks to your Cocoa application. Carthage builds your dependencies and provides you with binary frameworks, but you retain full control over your project structure and setup. Carthage does not automatically modify your project files or your build settings.
